...
The js\_header method define the JavaScript costants that will be used in the client side to make links asynchronos. It is called in the header of the page:
```
<head>
  <?php $balah->js_header(); ?>
  ...
